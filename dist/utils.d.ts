...
export declare function generateFile(filename: 'commit-msg' | 'pre-commit' | 'prepare-commit-msg' | 'lint-staged.config.js' | 'verify-commit-msg.js' | '.eslintrc.js' | 'prettier.config.js' | 'stylelint.config.js' | 'extensions.json' | 'launch.json' | 'settings.json' | '.npmrc' | '.ls-lint.yml', { packageFieldName, contentFile, exclude, output }: {
    /**
