...
function isExist(config, packageFieldName, filePath) {
    ...
    if (config.length === 0 && !packageFieldName && filePath) {
        flag = (0, fs_1.existsSync)((0, path_1.resolve)(root_1.cwd, filePath));
    }
    if (packageFieldName && root_1.pkg[packageFieldName]) {
        ...
        for (var _i = 0, config_1 = config; _i < config_1.length; _i++) {
            var s = config_1[_i];
            if ((0, fs_1.existsSync)((0, path_1.resolve)(root_1.cwd, s))) {
                flag = true;
                break;
            }
        }
...
function writeFile(file) {
    ...
    if (!(0, fs_1.existsSync)(editorconfig)) {
        console.log("\u001B[32m\u221A \u001B[90m".concat(file, "\u001B[0m"));
        (0, fs_1.writeFileSync)(editorconfig, (0, fs_1.readFileSync)((0, path_1.resolve)(__dirname, "../".concat(file))));
    }
}
...
function generateFile(filename, _a) {
    ...
    if (!isExistFile) {
        ...
        var content = (0, fs_1.readFileSync)((0, path_1.resolve)(__dirname, contentFile)).toString();
        if (exclude) {
            content = content
                .split('\n')
        ...
        (0, fs_1.writeFileSync)((0, path_1.resolve)(root_1.cwd, output), content);
    }
}
